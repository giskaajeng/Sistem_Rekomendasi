...
<head>
    ...
    <style>
        * {
        ...
        /* Legend - desktop and tablet default */
        .legend {
            width: 280px;
            background: white;
            border-radius: 12px;
        ...
        /* Mobile: hide legend by sliding from right */
        @media (max-width: 768px) {
            #map { min-height: calc(100vh - 120px); }
            ...
            .legend {
                ...
                right: 0;
                height: 50vh;
                width: 50vw; /* show half the screen on mobile */
                max-width: 420px;
            ...
            /* ensure map content sits under legend when opened */
...
<body>
    ...
    <div class="container">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="peta_user.php" class="active">
                        <span class="menu-icon">
    ...
    <script>
        ...
        toggleLegendBtn.addEventListener('click', function() {
            ...
            if (isMobile) {
                // on mobile slide legend in from right
                const opened = legendEl.classList.toggle('open');
                this.classList.toggle('active', opened);
                // prevent background scroll when legend open (optional)
                document.body.style.overflow = opened ? 'hidden' : '';
            } else {
                // desktop: keep previous hide/show behavior
                const hidden = legendEl.classList.toggle('hidden');
                this.classList.toggle('active', hidden);
            }
            // redraw map after animation
            setTimeout(() => {
