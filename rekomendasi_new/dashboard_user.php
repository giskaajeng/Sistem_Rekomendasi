...
// Count statistics
// Gunakan perbandingan case-insensitive untuk tingkat_pendidikan dan hitung desa unik
...
<body>
        ...
        <main class="main-content">
            ...
            <div class="info-section">
                ...
                <div class="info-cards-grid">
                    <a href="rekomendasi_user.php" class="info-card">
                    ...
                    <a href="peta_user.php" class="info-card">
                        <div class="info-card-icon">
    ...
    <script>
        ...
        document.addEventListener('click', function(event) {
            ...
            if (window.innerWidth <= 768) {
                // Jangan tutup jika click pada toggle button
                if (event.target === toggle || toggle.contains(event.target)) {
                    return;
                }
                
                // Tutup jika click di luar sidebar
